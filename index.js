...
$("#navSearch").click(function () {
  $("#second-Search").removeClass("d-none");
  ...
  $("#addSearch").click(function (e) {
   ...
   <div class="row intro  mt-5 text-white">
      ...
      document.querySelector("#SearchChange").innerHTML = int;
    }
    Instruc(result);
  });
});
...
$("#navCategories").click(function () {
  ...
  async function searchCategories() {
    ...
    displaycategory.innerHTML = cartoona;
  }
  searchCategories();

$("#displaycategory").click(function (e) {
  let allImg = $(e.target).text();
